...
def get_file_content(workin_directory, file_path):
    work_dir_path = os.path.abspath(workin_directory)
    target_file_path = os.path.abspath(os.path.join(workin_directory,file_path))
